...
class ConversationResource(ModelResource):
    ...
    council_members = fields.ToManyField('accounts.api.UserResource', 'council_members', full=True)
...
class TextResource(ModelResource):
    ...
    conversation = fields.ForeignKey('vortex.api.ConversationResource', 'conversation', null=True)
